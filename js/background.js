...
chrome.runtime.onInstalled.addListener(function () {
    ...
    var data = {
        ...
        'title': 'Wii Shop Channel Music - Chilean Edition instalada!!',
    }
    // Set message and handlers for notification
    if (navigator.userAgent.includes("Firefox")) {
        // Firefox supports does not support buttons in notifications
        data.message = 'Ahora podrás escuchar el tema de Wii Shop mientras  visitas tus páginas web de compras, haz click en la barra de tareas para modificar la configuración, o bien haz click en esta notificación.'
        ...
        handleNotif = function (id) {
            chrome.notifications.onButtonClicked.addListener(function (id, i) {
                if (i === 0) {
                    ...
                    chrome.tabs.create({ url: 'https://github.com/dargor980' })
                }
            })
        }
    }
